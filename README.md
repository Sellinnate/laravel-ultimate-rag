...
[![Tests](https://img.shields.io/badge/tests-616%20passing-brightgreen)](https://github.com/Sellinnate/laravel-ultimate-rag/actions/workflows/run-tests.yml)
...
```bash
composer test         # run the Pest suite (616 tests)
...
Quality gates kept green on every change: **616 tests**, **PHPStan level 8**,
